...
if __name__ == "__main__":
    ...
    img_folder = r'\\scallop\User\cheng\public_platform\v1_public\landmark_segmentation_uncertainty\test\img'
    seg_folder = r'\\scallop\User\cheng\public_platform\v1_public\landmark_segmentation_uncertainty\test\results\vertebrae_bayesian_segmentation_original'
    csv_folder = r'\\scallop\User\cheng\public_platform\v1_public\landmark_segmentation_uncertainty\test\results\vertebrae_localization'
    vis_folder = r'\\scallop\User\cheng\public_platform\v1_public\landmark_segmentation_uncertainty\test\visualization'
